...
test("should convert object to array notation", () => {
	expect(objectToArrayNotation({ lg: 400, sm: 100, base: 40 })).toEqual([40, 100, null, 400]);
	...
	expect(objectToArrayNotation({ base: 100, lg: 1300 })).toEqual([100, null, null, 1300]);
	expect(objectToArrayNotation({ base: 100, md: 400 })).toEqual([100, null, 400]);
